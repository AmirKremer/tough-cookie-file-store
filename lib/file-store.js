...
function FileCookieStore(redisClient, cookieId = 'default') {
    Store.call(this);
...
FileCookieStore.prototype.loadFromRedis = function(cb) {
    var self = this;
    loadFromFile(this.redisClient, this.filePath, function(dataJson) {
        if (dataJson) {
            self.idx = dataJson;
        }
        cb(dataJson);
...
FileCookieStore.prototype.putCookie = function(cookie, cb) {
    ...
    saveToFile(this.redisClient, this.filePath, this.idx, function() {
        cb(null);
    });
};
...
function saveToFile(client, filePath, data, cb) {
    var wo = _writing_[filePath];
    // If not writing to this file, start writing right now
    if ( !wo ) {
        writeFile(client, filePath, data, [cb]);
    }
...
function loadFromFile(client, filePath, cb) {
